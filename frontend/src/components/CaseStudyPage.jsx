...
const CASE_STUDIES = {
  ...
  'eta': {
    title: 'ETA',
    subtitle: 'Performance Marketing Campaign Execution',
    category: 'Digital Campaigns',
    year: '2024',
    tag: 'Performance Marketing',
    image: null,
    overview: 'ETA required a comprehensive digital marketing campaign to drive conversions and increase customer acquisition. We managed multi-channel advertising and optimization.',
    challenge: 'Limited marketing budget with high customer acquisition cost (CAC). Needed to maximize ROI across all digital channels.',
    solution: 'Implemented targeted Google Ads and social media advertising campaigns with continuous A/B testing. Optimized landing pages and retargeting strategies. Implemented conversion tracking and analytics.',
    results: 'Achieved 280% ROI on ad spend. Reduced CAC by 35% while increasing conversion rate by 48%. Generated 500+ qualified leads.',
    process: [
      { title: 'Planning', description: 'Campaign strategy and budget allocation' },
      { title: 'Execution', description: 'Multi-channel ad deployment' },
      { title: 'Optimization', description: 'A/B testing and performance tuning' },
      { title: 'Analysis', description: 'ROI tracking and reporting' },
    ],
  },
  'net-zero': {
    title: 'NET ZERO',
